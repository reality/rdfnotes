...
purposes\cite{humontology}. One particular realm of discovery is drug discovery,
...
A good example of a large RDF(S) dataset is DBPedia, which aims to extract
information from the online encyclopaedia website Wikipedia and provide it in a
structured and machine-processable format, available for free on the web. At the
time of writing, it had collected information on more than four million objects
and had collected more than 470million 'facts' overall.
